function p = priceTransformedSABRDensity(isCall, strike, alpha, beta, nu, rho, forward, T, P, PL,PR, zmin, zmax, h) 
...
p = priceTransformedSABRDensity(1, forward, alpha, beta, nu, rho, forward, T, P, PL, PR, zmin, zmax, h)
plot(F,P)
