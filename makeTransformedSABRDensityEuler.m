function [P,PL,PR, zm, zmin, zmax, h] = makeTransformedSABRDensityEuler(alpha, beta, nu, rho, forward, T, N, timesteps, nd)
  %init h,F and Q
  ...
  Emdt = exp(rho*nu*alpha*Gammam*dt); Emdt(1)= Emdt(2); Emdt(J+2)= Emdt(J+1);
...
[P, PL, PR, zm, zmin, zmax, h] = makeTransformedSABRDensityEuler(alpha, beta, nu, rho, forward, T, N, timesteps, 3);
