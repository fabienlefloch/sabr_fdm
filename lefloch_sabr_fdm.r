...
#ggsave(file="/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_cn_500_40.eps",width=5,height=4)


M<-read.table('/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_cn_500_40_5.txt', header=TRUE)
...
ggsave(file="/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_cn_500_40_5.eps",width=5,height=4)

M<-read.table('/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_cn_500_1280_5.txt', header=TRUE)
qplot(F, Q, data=M, color=factor(t), linetype=factor(t), geom="line", ylab="probability density")+coord_cartesian(xlim=c(0.95,1.05))+scale_color_discrete(name="t")+scale_linetype_discrete(name="t")+opts(legend.direction = "vertical", legend.position = c(0.75,0.75))
ggsave(file="/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_cn_500_1280_5.eps",width=5,height=4)

M<-read.table('/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_cn_500_640_5.txt', header=TRUE)
qplot(F, Q, data=M, color=factor(t), geom="line", ylab="probability density")+coord_cartesian(xlim=c(0.95,1.05))
ggsave(file="/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_cn_500_640_5.eps",width=5,height=4)+opts(legend.direction = "vertical", legend.position = c(0.75,0.75))

# CN 5
M<-read.table('/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_cn_500_5_5.txt', header=TRUE)
qplot(F, Q, data=M, color=factor(t), linetype=factor(t), geom="line", ylab="probability density")+coord_cartesian(xlim=c(0.95,1.05))+scale_color_discrete(name="t")+scale_linetype_discrete(name="t")+opts(legend.direction = "vertical", legend.position = c(0.75,0.75))
ggsave(file="/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_cn_500_5_5.eps",width=5,height=4)

# LS
M<-read.table('/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_ls_500_5_5.txt', header=TRUE)
qplot(F, Q, data=M, color=factor(t), linetype=factor(t), geom="line", ylab="probability density")+coord_cartesian(xlim=c(0.95,1.05))+scale_color_discrete(name="t")+scale_linetype_discrete(name="t")+opts(legend.direction = "vertical", legend.position = c(0.75,0.75))
ggsave(file="/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_ls_500_5_5.eps",width=5,height=4)

# LMG3
M<-read.table('/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_lm3_500_5_5.txt', header=TRUE)
qplot(F, Q, data=M, color=factor(t), linetype=factor(t), geom="line", ylab="probability density")+coord_cartesian(xlim=c(0.95,1.05))+scale_color_discrete(name="t")+scale_linetype_discrete(name="t")+opts(legend.direction = "vertical", legend.position = c(0.75,0.75))
ggsave(file="/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_lmg3_500_5_5.eps",width=5,height=4)

# RAN
M<-read.table('/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_ran_500_5_5.txt', header=TRUE)
qplot(F, Q, data=M, color=factor(t), linetype=factor(t), geom="line", ylab="probability density")+coord_cartesian(xlim=c(0.95,1.05))+scale_color_discrete(name="t")+scale_linetype_discrete(name="t")+opts(legend.direction = "vertical", legend.position = c(0.75,0.75))
ggsave(file="/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_ran_500_5_5.eps",width=5,height=4)

M<-read.table('/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_ran_500_5.txt', header=TRUE)
...
ggsave(file="/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_ran_500_5.eps",width=5,height=4)


# TRBDF2
M<-read.table('/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_trbdf2_500_10_5.txt', header=TRUE)
qplot(F, Q, data=M, color=factor(t), linetype=factor(t), geom="line", ylab="probability density")+coord_cartesian(xlim=c(0.95,1.05))+scale_color_discrete(name="t")+scale_linetype_discrete(name="t")+opts(legend.direction = "vertical", legend.position = c(0.75,0.75))
ggsave(file="/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_trbdf2_500_10_5.eps",width=5,height=4)

M<-read.table('/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_trbdf2_500_10.txt', header=TRUE)
...
ggsave(file="/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_trbdf2_500_10.eps",width=5,height=4)

# LMG2
M<-read.table('/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_lmg2_500_10_5.txt', header=TRUE)
qplot(F, Q, data=M, color=factor(t), linetype=factor(t), geom="line", ylab="probability density")+coord_cartesian(xlim=c(0.95,1.05))+scale_color_discrete(name="t")+scale_linetype_discrete(name="t")+opts(legend.direction = "vertical", legend.position = c(0.75,0.75))
ggsave(file="/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_lmg2_500_10_5.eps",width=5,height=4)
...
# CNS
M<-read.table('/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_cns_500_10_5.txt', header=TRUE)
qplot(F, Q, data=M, color=factor(t), linetype=factor(t), geom="line", ylab="probability density")+coord_cartesian(xlim=c(0.95,1.05))+scale_color_discrete(name="t")+scale_linetype_discrete(name="t")+opts(legend.direction = "vertical", legend.position = c(0.75,0.75))
ggsave(file="/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_cns_500_10_5.eps",width=5,height=4)

M<-read.table('/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_cns_500_10.txt', header=TRUE)
...
ggsave(file="/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_cns_500_10.eps",width=5,height=4)

# PERF 500
M<-read.table('/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/perf_hagan_500.txt', header=TRUE)
M<-read.table('/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/perf_hagan_500_all.txt', header=TRUE)
...
ggsave(file="/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/perf_hagan_500_steps_all.eps",width=5,height=4)
...
ggsave(file="/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/perf_hagan_500_time_all.eps",width=5,height=4)

M<-read.table('/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/perf_ah_500_all.txt', header=TRUE)

qplot(TimeSteps, Error, data=M, color=Scheme, linetype=Scheme, geom="line", ylab="Volatility Error", xlab="Number of time steps")+scale_y_log10()+scale_x_log10()
ggsave(file="/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/perf_ah_500_steps_all.eps",width=5,height=4)
...
ggsave(file="/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/perf_density_ah_500_steps.eps",width=6,height=4)
...
qplot(TimeSteps, Error, data=M, color=Scheme, linetype=Scheme, geom="line", ylab="Volatility Error", xlab="Number of time steps")+scale_y_log10()+scale_x_log10()
ggsave(file="/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/perf_hagan_250_steps_all.eps",width=5,height=4)

qplot(Time, Error, data=M, color=Scheme, linetype=Scheme, geom="line", ylab="Volatility Error", xlab="Time(s)")+scale_y_log10()+scale_x_log10()
ggsave(file="/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/perf_hagan_250_time_all.eps",width=5,height=4)

M<-read.table('/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/perf_ah_200_all.txt', header=TRUE)

qplot(TimeSteps, Error, data=M, color=Scheme, linetype=Scheme, geom="line", ylab="Volatility Error", xlab="Number of time steps")+scale_y_log10()+scale_x_log10()
ggsave(file="/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/perf_ah_250_steps_all.eps",width=5,height=4)
...
qplot(Strike, Hagan, data=M, color="Hagan Formula", linetype="Hagan Formula", geom="line", ylab="probability density")+geom_line(aes(x=Strike,y=HaganPDE,color="Hagan PDE", linetype="Hagan PDE"))+scale_color_manual(name="Method",values=c(2,1))+scale_linetype_manual(name="Method", values=c(2,1))+opts(legend.direction = "vertical", legend.position = c(0.75,0.75))
ggsave(file="/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_cn_640_40.eps",width=5,height=4)


M<-read.table('/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_cn_640_40_5.txt', header=TRUE)
qplot(F, Q, data=M, color=factor(t), linetype=factor(t), geom="line", ylab="probability density")+coord_cartesian(xlim=c(0.95,1.05))+scale_color_discrete(name="t")+scale_linetype_discrete(name="t")+opts(legend.direction = "vertical", legend.position = c(0.75,0.75))
ggsave(file="/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_cn_640_40_5.eps",width=5,height=4)

M<-read.table('/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_cn_640_1280_5.txt', header=TRUE)
qplot(F, Q, data=M, color=factor(t), linetype=factor(t), geom="line", ylab="probability density")+coord_cartesian(xlim=c(0.95,1.05))+scale_color_discrete(name="t")+scale_linetype_discrete(name="t")+opts(legend.direction = "vertical", legend.position = c(0.75,0.75))
ggsave(file="/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_cn_640_1280_5.eps",width=5,height=4)

M<-read.table('/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_cn_640_640_5.txt', header=TRUE)
qplot(F, Q, data=M, color=factor(t), geom="line", ylab="probability density")+coord_cartesian(xlim=c(0.95,1.05))
ggsave(file="/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_cn_640_640_5.eps",width=5,height=4)+opts(legend.direction = "vertical", legend.position = c(0.75,0.75))

# LMG2
M<-read.table('/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_lmg2_640_10_5.txt', header=TRUE)
qplot(F, Q, data=M, color=factor(t), linetype=factor(t), geom="line", ylab="probability density")+coord_cartesian(xlim=c(0.95,1.05))+scale_color_discrete(name="t")+scale_linetype_discrete(name="t")+opts(legend.direction = "vertical", legend.position = c(0.75,0.75))
ggsave(file="/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_lmg2_640_10_5.eps",width=5,height=4)

# TRBDF2
M<-read.table('/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_trbdf2_640_10_5.txt', header=TRUE)
qplot(F, Q, data=M, color=factor(t), linetype=factor(t), geom="line", ylab="probability density")+coord_cartesian(xlim=c(0.95,1.05))+scale_color_discrete(name="t")+scale_linetype_discrete(name="t")+opts(legend.direction = "vertical", legend.position = c(0.75,0.75))
ggsave(file="/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_trbdf2_640_10_5.eps",width=5,height=4)

M<-read.table('/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_trbdf2_640_10.txt', header=TRUE)
qplot(Strike, Hagan, data=M, color="Hagan Formula", linetype="Hagan Formula", geom="line", ylab="probability density")+geom_line(aes(x=Strike,y=HaganPDE,color="TR-BDF2", linetype="TR-BDF2"))+scale_color_manual(name="Method",values=c(2,1))+scale_linetype_manual(name="Method", values=c(2,1))+opts(legend.direction = "vertical", legend.position = c(0.75,0.75))
ggsave(file="/home/fabien/scala-workspace/quantscale/doc/lefloch_sabr_fdm/density_hagan_trbdf2_640_10.eps",width=5,height=4)
