...
Bathe extends the method to three-stages, using 2 stages of the trapezoidal rule and 1 stage of third order backward difference scheme (BDF3) in \citep{bathe2005composite}.
